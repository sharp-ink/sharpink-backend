...
import io.sharpink.rest.dto.story.ChapterDto;
...
public class ChapterMapper {
	 ...
	 */
	public ChapterDto mapDto(Chapter source) {
	 ...
	 */
	public List<ChapterDto> mapDtos(List<Chapter> source) {

		List<ChapterDto> target = new ArrayList<>();
	 ...
	 */
	public Chapter map(ChapterDto source) {
	 ...
	 */
	public List<Chapter> map(List<ChapterDto> source) {

		List<Chapter> target = new ArrayList<>();

		for (ChapterDto chapterDto : source) {
			target.add(map(chapterDto));
		}
