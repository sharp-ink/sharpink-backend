...
class UserControllerTest {
  ...
  public void updateUser() {
    // given
    when(userServiceMock.updateUser(anyLong(), any(UserPatchRequest.class))).thenReturn(new UserResponse());

    // when
    Long id = RandomUtils.nextLong();
    UserPatchRequest userPatchRequest = new UserPatchRequest();
    UserResponse userResponse = userController.updateUser(id, userPatchRequest);
    ...
    verify(userServiceMock).updateUser(idAC.capture(), userPatchRequestAC.capture());
